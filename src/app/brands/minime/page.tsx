      ...
      const sampleCollections: Collection[] = [
        {
          ...
          is_featured: true,
          is_active: true,
          product_count: productsData?.filter(p => p.title.toLowerCase().includes('fun')).length || 0
        },
        {
          id: '2',
          name: 'Bright & Bold',
          ...
          is_featured: true,
          is_active: true,
          product_count: productsData?.filter(p => p.title.toLowerCase().includes('bright')).length || 0
        },
        {
          id: '3',
          name: 'Modern Comfort',
          ...
          is_featured: false,
          is_active: true,
          product_count: productsData?.filter(p => p.title.toLowerCase().includes('comfort')).length || 0
        }
      ]
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4 lg:gap-6">
                    ...
                    <CardContent className="p-2 sm:p-4 lg:p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="text-green-600 hover:text-green-800 hover:bg-green-50 text-xs sm:text-sm px-1 sm:px-2"
                        >
                    ...
                    <div className="relative h-48 bg-gradient-to-br from-green-100 to-yellow-100">
                      {collection.image_url ? (
                        <img
                          src={collection.image_url}
                          alt={collection.name}
                          className="w-full h-full" style={{ objectFit: "cover" }} group-hover:scale-105 transition-transform duration-300"
                        />
                      ) : (
                        <div className="w-full h-full relative overflow-hidden">
              ...
              {collections.length > 2 && (
                <motion.div
                  whileHover={{ y: -2, scale: 1.01 }}
                  className="lg:hidden"
                  onClick={() => router.push('/collections?brand=minime')}
                >
                  <Card className="bg-white/90 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300 border border-green-200/50 overflow-hidden cursor-pointer">
                    <div className="relative h-24 bg-gradient-to-br from-green-100 to-yellow-100 relative overflow-hidden">
                      <div className="text-center">
                        <Package className="w-8 h-8 text-green-400 mx-auto mb-2" />
                        <span className="text-xs text-green-600 font-medium">+{collections.length - 2} more</span>
                      </div>
                    </div>
                    <CardContent className="p-2 text-center">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-green-600 hover:text-green-800 hover:bg-green-50 text-xs px-1"
                      >
                        View All →
                      </Button>
                    </CardContent>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.filter(p => p.is_featured).slice(0, 3).map((product, index) => (
              ...
              >
                <Card className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-green-200/50 overflow-hidden">
                  <div className="relative">
                    <div className="aspect-[3/4] bg- relative overflow-hiddengradient-to-br from-green-100 to-yellow-100">
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-semibold text-green-800 text-sm line-clamp-2">
                        {product.title}
                      </h3>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
              ...
              <div className="relative w-full sm:w-auto">
                <input
                  ...
                  className="w-full sm:w-64 pl-10 pr-4 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white/80"
                />
              ...
              <select
                ...
                className="w-full sm:w-auto px-4 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white/80"
              >
            ...
            {viewMode === 'grid' ? (
              ...
              >
                {filteredAndSortedProducts.map((product, index) => (
                  ...
                  >
                    <Card 
                      className="bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-green-200/50 cursor-pointer"
                      onClick={() => handleProductClick(product)}
                    >
                      <CardContent className="p-6">
                        <div className="flex items-center gap-6">
                          <div className="relative w-24 h-24 flex-shrink-0">
                            <div className="w-full h-full bg-gradient-to-br from-green-100 to-yellow-100 rounded-lg overflow-hidden">
                              {product.featured_image ? (
                                <img
                                  src={product.featured_image}
                                  alt={product.title}

...
export default function EditAddressPage() {
  ...
  useEffect(() => {
    const getUserAndAddress = async () => {
      ...
      if (error || !address) {
        showError('Not Found', 'Address not found or you do not have permission to edit it.')
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showError('Update Failed', 'Failed to update address. Please try again.')
    } finally {
      setSaving(false)
    }
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-yellow-50 py-12">
        <div className="max-w-2xl mx-auto px-4">
          <div className="text-center">
            ...
            />
            <p className="mt-4 text-gray-600 font-medium">Loading address...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 relative z-10">
        ...
        >
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-black mb-4">Edit Address</h1>
